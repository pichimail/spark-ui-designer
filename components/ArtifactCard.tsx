...
const ArtifactCard = React.memo(({ 
    ...
    // Logic to determine if we are in the initial analysis phase or actual code streaming
    const isAnalyzing = isBlurring && !artifact.html;
                    ...
                    <div className="generating-overlay">
                        {isAnalyzing ? (
                             <div className="scanner-loader">
                                 ...
                                 <div className="scanner-text">{artifact.styleName}</div>
                             </div>
                        ) : (
